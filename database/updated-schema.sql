...
INSERT INTO `tbl_amenities` VALUES (2,'Free Parking'),(3,'Free Wifi');
...
--
-- Table structure for table `tbl_post_amenities`
--

DROP TABLE IF EXISTS `tbl_post_amenities`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_post_amenities` (
  `id` int NOT NULL AUTO_INCREMENT,
  `post_id` int NOT NULL,
  ...
  CONSTRAINT `tbl_post_amenities_ibfk_1` FOREIGN KEY (`post_id`) REFERENCES `tbl_posts` (`id`) ON DELETE CASCADE,
  CONSTRAINT `tbl_post_amenities_ibfk_2` FOREIGN KEY (`amenity_id`) REFERENCES `tbl_amenities` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_post_amenities`
--

LOCK TABLES `tbl_post_amenities` WRITE;
/*!40000 ALTER TABLE `tbl_post_amenities` DISABLE KEYS */;
INSERT INTO `tbl_post_amenities` VALUES (5,10,2),(6,10,3);
/*!40000 ALTER TABLE `tbl_post_amenities` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-02-27 19:47:49
